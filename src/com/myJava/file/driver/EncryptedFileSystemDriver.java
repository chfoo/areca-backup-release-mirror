...
/**
 * Driver "chainable" apportant des fonctionnalit�s de cryptage.
 * <BR>Les fichiers (noms, r�pertoires et contenus) sont crypt�s avant traitement
 * par le Driver pr�d�cesseur. 
 * <BR>
...
extends AbstractLinkableFileSystemDriver {
    ...
    /**
     * La racine du r�pertoire qui sera crypt�.
     */
    ...
    /**
     * Crypte le nom du fichier/r�pertoire (nom court, sans r�pertoires parents) 
     */
    ...
    /**
     * D�crypte le nom du fichier/r�pertoire (nom court, sans r�pertoires parents) 
     */
