...
extends AbstractFileSystemPolicyXMLHandler {
    ...
    public FileSystemPolicy read(
        ...
        Node passwordNode = mediumNode.getAttributes().getNamedItem(XML_MEDIUM_SFTP_PASSWORD);
        ...
        if (serverNode == null && portNode == null && loginNode == null && passwordNode == null && dirNode == null) {
    ...
    public void write(
        ...
        if (! removeSensitiveData) {
            sb.append(XMLTool.encodeProperty(XML_MEDIUM_SFTP_PASSWORD, policy.getPassword()));
        }
