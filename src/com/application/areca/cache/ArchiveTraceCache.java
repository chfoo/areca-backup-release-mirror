 ...
 * (stock�es sous forme de maps).
 * <BR>A noter que toute tentative d'appel pour d'autres impl�mentations d'ArchiveMediums
 * d�clenchera une IllegalArgumentException.
...
public class ArchiveTraceCache extends AbstractArchiveDataCache {
    ...
    /**
     * Retourne la trace demand�e sous forme de Map.
     * <BR>La trace est lue du medium si elle n'est pas trouv�e en cache.
     */
    ...
    */
    ...
    /** 
     * Valide qu'on est bien en pr�sence d'un AbstractIncrementalFileSystemArchiveMedium
     */ 
