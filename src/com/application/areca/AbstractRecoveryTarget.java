...
implements HistoryEntryTypes, PublicClonable, Identifiable {
     ...
     * <BR>Relache �galement le lock sur la target, afin que d'autres op�rations puissent �tre effectu�es.
     */
    ...
    /**
     * R�tablit la version de l'archive
     */
    ...
    /**
     * M�thode � surcharger ... appel�e avant suppression de la target
     */
    ...
    /**
     * M�thode � surcharger ... appel�e apr�s suppression de la target
     */
    ...
    /**
     * Ex�cute l'ensemble des filtres sur la target
     * @param entry
     * @return
     */
    ...
    /**
     * Retourne la prochaine entry � stocker.
     * Attention : c'est cette m�thode qui a la charge d'appeler la m�thode
     * de filtre "acceptEntry".
     *  
     * @return La prochaine Entry, filtr�e.
     */
    public abstract RecoveryEntry nextElement(ProcessContext context) throws ApplicationException;
    
    /**
     * Construit un manifeste par d�faut pour le merge d'archives (utile pour le pr�remplissage du manifeste) 
     */
    ...
    /**
     * G�n�ration d'un identifiant de target.
     * Utile pour la log. 
     */
