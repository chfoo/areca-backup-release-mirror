 ...
 */
public class CreateShortcutWindow 
extends AbstractWindow {
    ...
    public CreateShortcutWindow(String initialDirectory, String initialFileNameSelected, String initialFileNameAll) {
        super();
    ...
    protected Control createContents(Composite parent) {
        ...
        btnBrowse.addListener(SWT.Selection, new Listener() {
            public void handleEvent(Event event) {
                ...
                String path = application.showFileDialog(FileSystemManager.getParent(f), CreateShortcutWindow.this, FileSystemManager.getName(f), RM.getLabel("app.buildbatch.label"), SWT.SAVE);
                if (path != null) {
